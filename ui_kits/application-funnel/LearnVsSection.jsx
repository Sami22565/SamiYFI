  ...
  return (
    <section style={{ padding: '140px 0 120px', position: 'relative' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 32px' }}>
        ...
        <Reveal style={{ position: 'relative', display: 'grid', gridTemplateColumns: '1fr 1fr' }}>
          ...
          <div style={{ position: 'absolute', left: '50%', top: '50%', transform: 'translate(-50%, -50%)', width: 64, height: 64, borderRadius: '50%', background: 'var(--accent-primary)', display: 'flex', alignItems: 'center', justifyContent: 'center', boxShadow: 'var(--shadow-glow-ember)', zIndex: 2 }}>
