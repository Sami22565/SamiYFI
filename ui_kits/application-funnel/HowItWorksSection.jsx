function HowItWorksSection({ Badge }) {
  ...
  return (
    <section id="how-it-works" style={{ padding: '140px 0', background: 'var(--bg-surface)', borderTop: '1px solid var(--border-subtle)', borderBottom: '1px solid var(--border-subtle)' }}>
            ...
            <div key={s.n} style={{
              ...
              {i % 2 === 0 ? (
                <React.Fragment>
                  ...
                  <div style={{ font: '800 96px var(--font-display)', color: 'var(--bg-card)', textAlign: 'right', lineHeight: 1 }}>{s.n}</div>
                </React.Fragment>
              ) : (
                <React.Fragment>
                  <div style={{ font: '800 96px var(--font-display)', color: 'var(--bg-card)', lineHeight: 1 }}>{s.n}</div>
                  <div>
                    <h3 style={{ font: '700 28px var(--font-body)', color: 'var(--text-primary)', margin: '0 0 10px' }}>{s.title}</h3>
                    <p style={{ font: 'var(--text-body-lg)', color: 'var(--text-secondary)', margin: 0, maxWidth: 560 }}>{s.body}</p>
                  </div>
